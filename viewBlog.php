...
<body>
    ...
    <div id="simple_post_container">
        <!-- viewing the blog contents the view blog page -->
        <?php
        foreach ($query as $q) ?>
        <main id="simple_post_container_main">
            ...
            <div id="simple_post_text">
                ...
                <?php echo $q['body'] ?>
                <br>
                <hr class="title" color="#eeeeee" style="height: 0.005rem;"><br>
            </div>
            <figure>
            ...
            <a href="editBlog.php?id=<?php echo $_REQUEST['id'] ?>" id="editButton" style="display: none; text-decoration:none;
        ...
        <!-- fetch the most recent blog other than the one currently displayed -->
